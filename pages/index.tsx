      ...
      >
        <article className="container mx-auto max-w-[1237px] lg:pt-16 sm:pt-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-8 mt-10">
            ...
            <div className="md:my-0 my-8">
              <h1 className="font-bold text-[1.5rem] lg:leading-[0.75rem]  text-white text-[1.42rem] mb-3 uppercase ">
            ...
            <div className="md:my-0 my-8">
              <Image
                ...
                className=" mr-2"
              />
              <h1 className="font-bold text-[1.5rem] lg:leading-[0.75rem] text-white text-[1.42rem] mb-3 uppercase lg:mt-10 max-sm:mt-16">
                Lorem ipsum dolor sit
              </h1>
              <p className="leading-8 text-[#FFFFFF] opacity-70">
      ...
      <article>
        <div className="overflow-hidden flex relative h-[50px]">
          ...
          <div className=" animate-marquee whitespace-nowrap text-white flex items-center">
            <span className="text-[1.2rem] font-bold mx-4 uppercase">
              lorem ipsum
            </span>
            <span className="text-[1.2rem] font-bold mx-4 uppercase">
              lorem ipsum
        ...
        {[1, 2, 3, 4, 5].map((_, index) => (
          ...
          >
            <div className=" rounded p-2 pb-2 ">
              <div className="relative h-[45px]" onClick={() =>{tab === index ? setTab(-1) :setTab(index)}}>
                {tab === index && (
                  <Image
                    src={backgroundImage}
